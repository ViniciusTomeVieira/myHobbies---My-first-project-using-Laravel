                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control{{$errors->has('rg') ? ' border-danger' : '' }}" id="rg" name="rg" value="{{old('rg')}}">
                                <small class="form-text text-danger">{!! $errors->first('rg') !!}</small>
                            </div>
                            <div class="form-group">
                                <label for="Nasc">Nasc</label>
                                <input type="date" class="form-control{{$errors->has('nasc') ? ' border-danger' : '' }}" id="nasc" name="nasc" value="{{old('nasc')}}">
                                <small class="form-text text-danger">{!! $errors->first('nasc') !!}</small>
                            </div>
                            <div class="form-group">
                                <label for="Cep">Cep</label>
                                <input type="text" class="form-control{{$errors->has('cep') ? ' border-danger' : '' }}" id="cep" name="cep" value="{{old('cep')}}">
                                <small class="form-text text-danger">{!! $errors->first('cep') !!}</small>
                            </div>
                            <div class="form-group">
                                <label for="Rua">Rua</label>
                                <input type="text" class="form-control{{$errors->has('rua') ? ' border-danger' : '' }}" id="rua" name="rua" value="{{old('rua')}}">
                                <small class="form-text text-danger">{!! $errors->first('rua') !!}</small>
                            </div>
                            <div class="form-group">
                                <label for="Bairro">Bairro</label>
                                <input type="text" class="form-control{{$errors->has('bairro') ? ' border-danger' : '' }}" id="bairro" name="bairro" value="{{old('bairro')}}">
                                <small class="form-text text-danger">{!! $errors->first('bairro') !!}</small>
                            </div>
                            <div class="form-group">
                                <label for="Cidade">Cidade</label>
                                <input type="text" class="form-control{{$errors->has('cidade') ? ' border-danger' : '' }}" id="cidade" name="cidade" value="{{old('cidade')}}">
                                <small class="form-text text-danger">{!! $errors->first('cidade') !!}</small>
                            </div>
                            <div class="form-group">
                                <label for="Estado">Estado</label>
                                <input type="text" class="form-control{{$errors->has('estado') ? ' border-danger' : '' }}" id="estado" name="estado" value="{{old('estado')}}">
